...
if __name__ == '__main__':
    ...
    # True: using planner for real events, False: using playground
    ...
    parser.add_argument('-o', '--observer', nargs='?', type=str,
                        help='observer(s) (e.g) "Akitaya et al." (to be quoted if including space characters)')
    ...
    parser.add_argument('-d', '--obsid', nargs='?', type=str, default=None,
                        help='obsid (e.g) SaCRA-MuSaSHI')
    parser.add_argument('-b', '--bands', nargs='?', type=str, default=None,
                        help='bands (e.g) R or "r i z" (to be quoted and spaced for multiple bands)')
